...
项目地址：https:\/\/github.com/firzencode/niky
...
备注：
链接中的斜杠要转义
# SIZE_IMAGE: 50%@./test_image.png
# SIZE_IMAGE: 200px@./test_image.png
...
+ [显示1]
# BG_IMAGE: ./test_bg_1.jpg
-> bg_menu
+ [显示2]
# BG_IMAGE: ./test_bg_2.jpg
-> bg_menu
+ [隐藏]
# BG_IMAGE: hide
-> bg_menu
...
使用输入框来修改变量
使用方式为 \# INPUT: 需要修改的变量名
并且在下一行，写一段内容，作为输入框上方的提示
